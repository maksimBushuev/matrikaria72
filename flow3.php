...
<body class="w3-sand">
    ...
    <nav id="nav" class="w3-container w3-bar w3-center w3-sand">
        <div class=" w3-half ">
            ...
            <a href="/flow2.php" class="w3-button w3-padding-large  w3-border w3-border-deep-purple  w3-round  w3-padding w3-hover-deep-purple menu_button ">Штучные цветы</a>
        </div>
        <div class=" w3-half">
            <a href="/flow3.php" class="w3-button w3-padding-large  w3-border w3-border-deep-purple  w3-round  w3-padding w3-deep-purple w3-hover-deep-purple menu_button ">Композиции</a>
    ...
    <main id="main" class="w3-container">
        <div id="flow3" class="w3-flex main_flex">
            <div w3-repeat="flow3" class="  w3-card-4 main_flex_div w3-panel w3-round-xlarge">
...
<script src="/js/flow3.js" defer></script>
