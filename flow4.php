...
<body class="w3-sand">
    ...
    <nav id="nav" class="w3-container w3-bar w3-center w3-sand">
        ...
        <div class=" w3-half">
            ...
            <a href="/flow4.php" class="w3-button w3-padding-large  w3-border w3-border-deep-purple  w3-round  w3-padding w3-deep-purple w3-hover-deep-purple menu_button ">Вкусняшки</a>
        </div>  
    </nav>
